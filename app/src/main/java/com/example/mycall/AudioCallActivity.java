...
public class AudioCallActivity extends AppCompatActivity {
    ...
    private String token, remoteFcmToken;
    int uid;
   ...
   /* private boolean checkSelfPermission(String permission, int requestCode) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        remoteFcmToken = getIntent().getStringExtra("remoteFcmToken");
        ...
        sendCallNotificationToRemoteUser(token,remoteFcmToken, "voice",channelName);
    }
    ...
    private void sendCallNotificationToRemoteUser(String channelToken, String remoteFcmToken, String callType, String channelName) {
    ...
    public void onSwitchSpeakerphoneClicked() {
       /* ImageView iv = (ImageView) view;
        ...
        mRtcEngine.setEnableSpeakerphone(!loudSpeakerOpen);
        loudSpeakerOpen = !loudSpeakerOpen;
    }
    ...
    private void joinChannel() {
        ...
        mRtcEngine.joinChannel(token, channelName, "Extra Optional Data", uid); // if you do not specify the uid, we will generate the uid for you
    }
    ...
    private void onRemoteUserLeft(int uid, int reason) {
        ...
        Log.d(TAG, "onRemoteUserLeft: "+reason + " UId: "+uid);
    }

    // Tutorial Step 6
    private void onRemoteUserVoiceMuted(int uid, boolean muted) {
        Log.d(TAG, "onRemoteUserVoiceMuted: "+muted + " UId: "+uid);
